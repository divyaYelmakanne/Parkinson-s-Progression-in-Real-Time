...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      daily_summaries: {
        Row: {
          avg_pd_index: number | null
          avg_tremor_frequency: number | null
          created_at: string | null
          id: string
      ...
      typing_test_results: {
        Row: {
          ...
          id: string
          motor_control_score: number | null
          pd_progression_index: number | null
          rhythm_variability: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "typing_test_results_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
